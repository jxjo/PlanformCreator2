...
class Dxf_Artist:
    ...
    def plot_planform (self):
        ...
        # make a single line for the planeform contour from 0,0 - root - le - tip - te - root 
        y_c = [0.0]
        x_c = [0.0]
        y_c.extend(y)
        x_c.extend(le)
    ...
    def plot_wingSections (self):
        ...
        for sec in self.wing.wingSections:
            ...
            airfoilText = "'"+ sec.airfoilNick()+"'" # + sec.airfoilName()
    ...
    def plot_title (self):
        ...
        x_m = x_m - 20 
        fontsize = (self.wing.rootchord / 230.0) * 6.0
        text = "Generated by Planeform Creator 2"
        self.msp.add_text(text, height = fontsize).set_placement(
                            (y_m, x_m), align=enums.TextEntityAlignment.TOP_LEFT)
