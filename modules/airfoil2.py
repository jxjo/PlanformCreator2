...
from airfoil2_geometry import Geometry_Splined, Geometry, Geometry_Bezier
...
class Airfoil2:
    ...
    @classmethod
    def asCopy (cls, sourceAirfoil: 'Airfoil2', pathFileName = None, 
                name=None, nameExt="-mod",
                geometry=None) -> 'Airfoil2':
        """
    ...
    def cloneTo (self, dir : str = None, destName : str = None) -> 'Airfoil2':
        """
        ...
        airfoil = Airfoil2.asCopy (self, name=destName, pathFileName=newPathFileName)
    ...
    def do_strak (self, airfoil1 : 'Airfoil2', airfoil2 : 'Airfoil2', blendBy : float):
