...
class Planform_Elliptical_StraightTE (Planform_Elliptical):
    ...
    """
    shortDescription = "Elliptical based planform with a straight trailing edge generated by functions.\n" + \
                       "Therefore either position or chord of a section can be defined.\n" + \
    ...
    def _planform_function (self, y):
        """
        calculates all relevant geo data of the planform at y with 
